...
import com.matejrajtar.shoppinglist.tasks.product.CreateProduct;
import com.matejrajtar.shoppinglist.tasks.product.CreateProduct.OnProductCreated;
import com.matejrajtar.shoppinglist.tasks.product.UpdateProduct;
import com.matejrajtar.shoppinglist.tasks.product.UpdateProduct.OnProductUpdated;
import com.matejrajtar.shoppinglist.utils.ResourceUtils;
import com.matejrajtar.shoppinglist.views.CreateProductView;
...
public class CreateProductActivity extends BaseActivity<CreateProductView> implements CreateProductViewObserver, OnCategoriesLoaded, OnProductCreated, OnProductUpdated {
    ...
    @Override
    public void onAction(String category, String name, String image, String inCart) {
        view.clearError();
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Product newProduct = new Product(category, name, image.toString(), inCart, false);
